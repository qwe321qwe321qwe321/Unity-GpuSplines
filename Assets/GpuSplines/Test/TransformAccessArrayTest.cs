...
namespace PeDev {
    public class TransformAccessArrayTest : MonoBehaviour {
	    ...
	    private List<GameObject> objectLists = new List<GameObject>();
	    ...
	    private void Start() {
		    ...
		    for (int i = 0; i < objectCount; i++) {
			    ...
			    objectLists.Add(newObject);
			    transformArray.Add(newObject.transform);
	    ...
	    private void Update() {
		    ...
		    }.Schedule(transformArray, m_JobHandle);
